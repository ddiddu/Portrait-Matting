...
class LRBranch(nn.Module):
    ...
    def forward(self, img, inference):
        ...
        pred_semantic = None
        if not inference:
            lr = self.conv_lr(lr8x) # [1, 1, 256, 256]
            pred_semantic = torch.sigmoid(lr) # [1, 1, 256, 256]
...
if __name__ == '__main__':
    ...
    print(pytorch_model_summary.summary(modnet, torch.zeros(1, 3, 256, 256), show_input=True))
