...
#         for params in self.lr_branch.conv_lr8x.parameters():
#             params.requires_grad = True
#         for params in self.hr_branch.tohr_enc4x.parameters():
#             params.requires_grad = True
        for params in self.hr_branch.tohr_hr4x.parameters():
            params.requires_grad = True
        for params in self.hr_branch.tohr_lr4x.parameters():
            params.requires_grad = True
        for params in self.hr_branch.conv_lr.parameters():
            params.requires_grad = True
